document.addEventListener('DOMContentLoaded', () => {
    ...
    const numQuestions = 19; // 随机生成的问题数量，最后一个问题是固定的
    const lastQuestion = {
    ...
    // 从 sessionStorage 中获取已生成的问题和用户的选择
    ...
    if (savedQuestions && savedUserChoices) {
        // 如果存在已保存的问题和用户选择，直接使用它们
        questions = savedQuestions;
        displayQuestions(questions, savedUserChoices);
    } else {
        // 否则生成新的问题
        questions = [
            {
